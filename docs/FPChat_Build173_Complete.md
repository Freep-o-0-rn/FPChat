...
Кодовая часть Build 173 завершена в `build/173-development` после прохождения статических/VM проверок.

Полная приёмка требует ручной multi-device регрессии. CI в репозитории не настроен.
