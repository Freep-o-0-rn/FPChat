...
Статус на 19.09.2026: методика и инструменты есть; сохранённого числового baseline ПК/мобильных устройств в репозитории нет. Совместные автоматические проверки на Build 173 описаны в [аудите 169–173](FPChat_Audit_169-173.md) и не подменяют измерения ниже. `legacyAuditBuild` / `legacyAuditScope` в runtime явно отличают исторический static audit от текущих активных ресурсов.
