...
assert(indexSource.indexOf('/message-store172.js') < indexSource.indexOf('/app.js'), 'MessageStore loader must be defined before app.js loader execution');
...
assert(appSource.includes("FPMessageStore172?.updateStatus"), 'message status must be mirrored into MessageStore');
