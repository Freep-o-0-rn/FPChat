...
- По просьбе пользователя в **план 175** включены пропадающий микрофон и ложный long-press при открытии бокового меню. Эти два UI-дефекта пока не объявляются исправленными.
