/* Build 112: inject isolated message-actions and message-pins server layers without rewriting server.js. */
const fs = require('fs');
...
Module._extensions['.js'] = function fpchatBuild112Loader(module, filename) {
  ...
  if (!source.includes(marker)) {
    throw new Error('FPChat Build 112 bootstrap: server.js startup marker was not found');
  }
