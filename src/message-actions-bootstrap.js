/* Build 147: inject isolated server feature layers without rewriting server.js. */
const fs = require('fs');
...
Module._extensions['.js'] = function fpchatBuild147Loader(module, filename) {
  ...
  if (!source.includes(marker)) {
    throw new Error('FPChat Build 147 bootstrap: server.js startup marker was not found');
  }
