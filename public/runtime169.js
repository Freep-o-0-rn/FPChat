...
(() => {
  ...
  // Build 186.2: bounded, explicit observations. No transport/timer/crypto
  ...
  const loading186 = (() => {
    ...
    function report() {
      ...
      return {
        schema:1, build:'186.2', mode:'passive-owner-hooks', installedAtMs:round(startedAt), enabled, limit:LIMIT, dropped, activeElementWatches:watches.size,
