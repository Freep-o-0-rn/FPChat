...
(() => {
  ...
  // Build 186.3: bounded, explicit observations. No transport/timer/crypto
  ...
  const loading186 = (() => {
    ...
    function report() {
      ...
      return {
        schema:1, build:'186.3', mode:'passive-owner-hooks', installedAtMs:round(startedAt), enabled, limit:LIMIT, dropped, activeElementWatches:watches.size,
    ...
    function download() {
      ...
      const link = document.createElement('a'); link.href = url; link.download = 'FPChat-186.3-loading.json';
